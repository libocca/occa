...
- [**API**](/api/)
  ...
  - [occa::function](/api/function/)
    - [argumentCount](/api/function/argumentCount)
    - [getArgTypes](/api/function/getArgTypes)
  ...
  - [occa::streamTag](/api/streamTag/)
    - [getReturnType](/api/function/getReturnType)
    - [operator ()](/api/function/operator_parentheses)
