...
set_optional_cxx_flag(SUPPORTED_WARN_CXX_FLAGS "-Wwrite-strings -Wfloat-equal"
                      "-Wcast-align -Wlogical-op" "-Wshadow")
...
if(CMAKE_CXX_COMPILER_ID STREQUAL "PGI")
  ...
  # `occa::trie<std::__cxx11::basic_string<char, std::char_traits<char>,
  # std::allocator<char> > >::getLongest(char const*, int) const':
  # occa/include/occa/tools/trie.tpp:238:(.text+0x5cdc): relocation truncated to
  # fit: R_X86_64_PC32 against `.rodata'
...
set(CMAKE_CXX_FLAGS_DEBUG
    "${SUPPORTED_WERROR_CXX_FLAGS} ${CMAKE_CXX_FLAGS_DEBUG}")
...
set_optional_c_flag(SUPPORTED_WARN_C_FLAGS
                    "-Wunused-function -Wunused-variable")
set_optional_c_flag(SUPPORTED_WARN_C_FLAGS "-Wwrite-strings -Wfloat-equal"
                    "-Wcast-align -Wlogical-op" "-Wshadow")
...
if(OCCA_ENABLE_FORTRAN)
  ...
  set(CMAKE_Fortran_FLAGS
      "${CMAKE_Fortran_FLAGS} ${SUPPORTED_WARN_Fortran_FLAGS}")
  ...
  set(CMAKE_Fortran_FLAGS_DEBUG
      "${CMAKE_Fortran_FLAGS_DEBUG} ${SUPPORTED_WERROR_Fortran_FLAGS}")

  set_optional_fortran_flag(SUPPORTED_WNO_INTEGER_DIVISION_Fortran_FLAGS
...
check_cxx_compiler_flag("-fno-strict-aliasing"
                        COMPILER_SUPPORTS_NO_STRICT_ALIASING)
