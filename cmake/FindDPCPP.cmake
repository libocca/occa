# ##############################################################################
# FIND module for DPCPP components This Find module is also distributed
# alongside the occa package config file!
# ##############################################################################
...
if(IntelSYCL_FOUND)
  ...
  find_path(
    DPCPP_INCLUDE_DIRS
    NAMES sycl/sycl.hpp
    PATHS ENV SYCL_ROOT ${SYCL_ROOT} ENV CMPLR_ROOT ${cxx_root_dir}
    PATH_SUFFIXES include include/sycl include/CL include/sycl/CL)
...
find_package_handle_standard_args(
  DPCPP REQUIRED_VARS DPCPP_INCLUDE_DIRS DPCPP_LIBRARIES DPCPP_FLAGS)

if(DPCPP_FOUND AND NOT TARGET OCCA::depends::DPCPP)
  # Create our wrapper imported target Put it in the OCCA namespace to make it
  # clear that we created it.
  ...
  set_target_properties(
    OCCA::depends::DPCPP
    PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "${DPCPP_INCLUDE_DIRS}"
