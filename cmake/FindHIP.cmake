# ##############################################################################
# FIND: HIP and associated helper binaries This Find module is also distributed
...
if(UNIX
  ...
  find_program(
    ...
    NAMES hipconfig
    PATHS "${HIP_ROOT_DIR}" ENV ROCM_PATH ENV HIP_PATH /opt/rocm
    PATH_SUFFIXES bin
    NO_DEFAULT_PATH)
  ...
  if(HIP_HIPCONFIG_EXECUTABLE AND NOT HIP_COMPILER)
    ...
    set(HIP_COMPILER
        ${_hip_compiler}
        CACHE STRING "HIP compiler as computed by hipconfig")
  ...
  if(HIP_PLATFORM)
    ...
    elseif(${HIP_PLATFORM} STREQUAL "nvidia")
      ...
      # find the shared library, rather than the static that find_package
      # returns
      find_library(
        CUDART_LIB
        NAMES cudart
...
if(HIP_FOUND AND NOT TARGET OCCA::depends::HIP)
  ...
  set_target_properties(
    OCCA::depends::HIP
    PROPERTIES INTERFACE_COMPILE_DEFINITIONS "${HIP_RUNTIME_DEFINE}"
