...
void testOtherNodes() {
  ...
  std::cout << "one             : " << one.toString() << '\n'
            ...
            << "constCast       : " << constCast(t1, var).toString() << '\n'
            << "staticCast      : " << staticCast(t1, var).toString() << '\n'
            << "reinterpretCast : " << reinterpretCast(t1, var).toString() << '\n'
            << "dynamicCast     : " << dynamicCast(t1, var).toString() << '\n'
