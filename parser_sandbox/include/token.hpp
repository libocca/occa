...
#define KEYWORD_OFFSET  (1 << 5)
#define OPERATOR_OFFSET (1 << 5)

#define TOKEN(enum_field, description) enum_field,
#define KEYWORD(enum_field, idx, description) enum_field  = (KEYWORD_OFFSET  + idx),
#define OPERATOR(enum_field, idx, description) enum_field = (OPERATOR_OFFSET + idx),
