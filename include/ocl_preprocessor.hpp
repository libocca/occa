...
#define OCL_IF3(OCL_BOOL, T_EXPR, F_EXPR) OCL_IF_##OCL_BOOL(T_EXPR, F_EXPR)
#define OCL_IF2(OCL_BOOL, T_EXPR, F_EXPR) OCL_IF3(OCL_BOOL, T_EXPR, F_EXPR)
#define OCL_IF(OCL_BOOL, T_EXPR, F_EXPR)  OCL_IF2(OCL_BOOL, T_EXPR, F_EXPR)
//==============================================================================
...
#define OCL_PARAM(N, ...)          VERBATIM(OCL_PARAM_##N(__VA_ARGS__))
...
#define OCL_ARGS_FOR_CHECK2(OCL_BOOL, START, END, EXPR_, ...) OCL_ARGS_FOR_CHECK_##OCL_BOOL(START, END, EXPR_, __VA_ARGS__)
#define OCL_ARGS_FOR_CHECK(OCL_BOOL, START, END, EXPR_, ...)  OCL_ARGS_FOR_CHECK2(OCL_BOOL, START, END, EXPR_, __VA_ARGS__)
...
#define OCL_FOR_CHECK2(OCL_BOOL, START, END, EXPR_) OCL_FOR_CHECK_##OCL_BOOL(START, END, EXPR_)
#define OCL_FOR_CHECK(OCL_BOOL, START, END, EXPR_)  OCL_FOR_CHECK2(OCL_BOOL, START, END, EXPR_)
...
#define OCL_ARGS_FOR_CHECK2_2(OCL_BOOL, START, END, EXPR_, ...) OCL_ARGS_FOR_CHECK_2_##OCL_BOOL(START, END, EXPR_, __VA_ARGS__)
#define OCL_ARGS_FOR_CHECK_2(OCL_BOOL, START, END, EXPR_, ...)  OCL_ARGS_FOR_CHECK2_2(OCL_BOOL, START, END, EXPR_, __VA_ARGS__)
...
#define OCL_FOR_CHECK_2_2(OCL_BOOL, START, END, EXPR_) OCL_FOR_CHECK_2_##OCL_BOOL(START, END, EXPR_)
#define OCL_FOR_CHECK_2(OCL_BOOL, START, END, EXPR_)  OCL_FOR_CHECK_2_2(OCL_BOOL, START, END, EXPR_)
