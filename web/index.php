...
<div style="width: 100%; background-color: #EAF5F9; padding: 20px 0 20px 0;">
  <div style="height: 250px; width: 1060px; margin: 20px auto 20px auto; position: relative; clear: both;">
    ...
    <div style="width: 20px; height: 250px; float: left; display: block; position: relative"></div>
